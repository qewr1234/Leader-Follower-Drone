...
- **SITL 확인은 아직입니다.** 정현파 리더 시나리오 `leader_sine`(`sitl/README.md`) 을 현재 코드와 수정 전
  코드(커밋 e4b4cd7)로 각각 돌려 진폭비(예측 0.70 / 2.3)를 대조해야 합니다.
...
- 수정의 실제 FC 검증(`leader_sine`)은 아직 실행되지 않았습니다.
